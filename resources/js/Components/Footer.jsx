    ...
    <VStack background={"gray.100"} w={"full"} p={8} mt={16}>
      ...
      >
        ...
        <Flex direction={"column"} gap={4} textAlign={"left"}>
          ...
          <Text>Dapatkan E-mail Baru tentang penawaran dan info menarik.</Text>
          <InputGroup size="md">
            <Input
            ...
            <InputRightElement width="auto">
              <Button size="md" colorScheme="blue" px={4} borderLeftRadius={0}>
                Kirim
              </Button>
            </InputRightElement>
          </InputGroup>
      ...
      <Container maxW="container.xl">
        <Text textAlign={"center"}>
          ...
          <Text as="span" ml={1} fontWeight={"bold"} color={"blue.500"}>
            SeeTrip.id
          </Text>
        </Text>
      </Container>
