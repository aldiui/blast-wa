      ...
      <Card w="full" p={2} h={"auto"}>
        ...
        <form onSubmit={submit}>
            ...
            <SimpleGrid columns={{ base: 1, xl: 2 }} spacing={6}>
              ...
              <FormControl isInvalid={errors.syahriyah}>
                ...
                <Input
                  ...
                  onChange={(e) => setData("syahriyah", e.target.value)}
                />
                {errors.syahriyah && (
                  <FormErrorMessage fontSize={"xs"}>
                    {errors.syahriyah}
              ...
              <FormControl isInvalid={errors.field_trip}>
                ...
                <Input
                  ...
                  onChange={(e) => setData("field_trip", e.target.value)}
                />
                {errors.field_trip && (
                  <FormErrorMessage fontSize={"xs"}>
                    {errors.field_trip}
              ...
              <FormControl isInvalid={errors.daftar_ulang}>
                <FormLabel htmlFor="daftar_ulang" fontSize={"sm"}>
                  Daftar Ulang
                  <Text display={"inline"} color="red">
                    *
                  </Text>
                ...
                <Input
                  ...
                  onChange={(e) => setData("daftar_ulang", e.target.value)}
                />
                {errors.daftar_ulang && (
                  <FormErrorMessage fontSize={"xs"}>
                    {errors.daftar_ulang}
          ...
          <CardFooter>
            ...
            <Button as={Link} href={"/pengaturan"} colorScheme="gray" ml={3}>
